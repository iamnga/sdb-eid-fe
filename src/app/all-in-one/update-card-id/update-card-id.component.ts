...
export class UpdateCardIdComponent implements OnInit {
  ...
  updateCustomer() {
    ...
    this.customerUpdateData.customerIDNew = this.aioSvc.customerInfo.customerID;
    ...
    this.customerUpdateData.issPlace = this.aioSvc.customerInfo.issuePlace;
    this.customerUpdateData.isUpdateAddress = false;
    this.customerUpdateData.qrContent = 'NonQRContent';
    ...
    this.updateCustomerRequestData.customerUpdate = this.customerUpdateData;
